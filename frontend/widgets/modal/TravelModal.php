...
class TravelModal extends BaseModal
{
    ...
    protected function renderBodyContent ()
    {
        $content =
            ...
            Html::tag('p', 'Полис покрывает риски, связанные с ухудшением здоровья застрахованного, это могут быть обычные заболевания, экстренные (в том числе операционные) вмешательства, получение медицинской помощи при травме или несчастном случае.').
            Accordion::widget([
                'items' => [
                    [
