...
class OpoModal extends BaseModal
{
    ...
    {
        $content =
            Html::tag('p', 'Согласно законодательству РФ, без соответствующего полиса страхования гражданской ответственности перед третьими лицами эксплуатация ОПО не допускается Защита бизнеса от непредвиденных расходов, связанных с обязанностью компенсировать ущерб третьим лицам, которой может быть нанесен в результате деятельности владельцев опасных производственных объектов.').
            Button::widget([
                'text' => 'ОФОРМИТЬ',
                'options' => [
                    'class' => 'btn-in-modal',
